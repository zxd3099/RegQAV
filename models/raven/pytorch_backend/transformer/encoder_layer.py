...
from models.raven.pytorch_backend.transformer.norm import LayerNorm, BatchNorm1d
...
class EncoderLayer(nn.Module):
    ...
    :param pytorch_backend.transformer.attention.
        MultiHeadedAttention self_attn: self attention module
        RelPositionMultiHeadedAttention self_attn: self attention module
    :param pytorch_backend.transformer.positionwise_feed_forward.
        PositionwiseFeedForward feed_forward:
        feed forward module
    :param pytorch_backend.transformer.convolution.
    ...
    def forward(self, x_input, mask, cache=None, rtn_attn=True):
        ...
        if pos_emb is not None:
            x_att, attn = self.self_attn(x_q, x, x, pos_emb, mask, rtn_attn)
        else:
            x_att = self.self_attn(x_q, x, x, mask, rtn_attn)
