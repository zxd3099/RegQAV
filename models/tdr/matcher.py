...
class HungarianMatcher(nn.Module):
    ...
    def __init__(self,
        ...
        """
        Creates the matcher
        :param cost_class: This is the relative weight of the classification error in the matching cost
        :param cost_seg: This is the relative weight of the L1 error of the segment coordinates in the matching cost
        :param cost_iou: This is the relative weight of the iou loss of the segment in the matching cost
        :param diou:
        """
        super().__init__()
    ...
    def forward(self, outputs, targets, encoder=False):
        ...
        # Compute the iou cost between segments
        out_seg = torch.stack([out_seg[..., 0], out_seg[..., 1].exp()], dim=-1)
        if self.diou:
        ...
        if outputs.get('mask') is not None:
